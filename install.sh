...
systemctl enable sysctl-custom
    ...
    wget -O /tmp/gost.tar.gz https://github.com/go-gost/gost/releases/download/v3.0.0-nightly.20241107/gost_3.0.0-nightly.20241107_linux_amd64.tar.gz
...
wget -O /etc/gost/install.sh https://github.com/HadiTak/Gost-ip6/raw/main/install.sh
